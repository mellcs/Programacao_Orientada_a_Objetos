...
public class Viagens {
    ...
    public Viagens(double quilometragem, String destino, List<Eletropostos> eletropostosCadastrados, List<VeiculosEletricos> frota) {
    ...
    public void comecarViagem() {
        ...
        if (encontrado) {
            ...
            scanner.nextLine(); // Limpeza do buffer após nextDouble()
